...
user1 = User.find_or_create_by! email: 'test1@gmail.com'
puts "Re-creating Favourites ..."
Favourite.destroy_all
Favourite.create(user_id: 1, country_name: 'USA')
...
Favourite.create(user_id: 2, country_name: 'Angola')
Favourite.create(user_id: 2, country_name: 'Algeria')
